...
public class BarKindnessSlide : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    private float _slideY = -300f;   // Y final al apoyar el cursor
    ...
    private Vector2 _miniGamePos = new Vector2(-600f, -700f);
